...
type CreateShippingRequest struct {
	...
	Items         []*ShippingItem        `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"` // Lista de itens do pedido
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateShippingRequest) GetCustomerId() int64 {
	if x != nil {
		return x.CustomerId
	}
	return 0
...
type CreateShippingResponse struct {
	...
	DeliveryDays  int32                  `protobuf:"varint,2,opt,name=delivery_days,json=deliveryDays,proto3" json:"delivery_days,omitempty"` // Prazo de entrega calculado
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"customerId\x12#\n" +
	"\x05items\x18\x03 \x03(\v2\r.ShippingItemR\x05items\"^\n" +
	"\x16CreateShippingResponse\x12\x1f\n" +
	"\vshipping_id\x18\x01 \x01(\x03R\n" +
	"shippingId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x05R\fdeliveryDays2E\n" +
	"\bShipping\x129\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponseB7Z5github.com/ruandg/microservices-proto/golang/shippingb\x06proto3"
